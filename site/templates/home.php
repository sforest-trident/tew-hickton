			...
			<div class="quick-nav-section">
				...
				<ul class="ql-list">
					<?php
						...
						foreach($page->home_quicklinks as $quicklink) {
							if(!empty($quicklink->text_input)) {
								?>
								<li class="ql-item"><a href="<?php echo $quicklink->page_link->url;?>"><?php echo $quicklink->text_input; ?></a></li>
								<?php
							}else{
								?>
								<li class="ql-item"><?php echo$quicklink->page_link("<a href='{url}'>{title}</a>"); ?></li>
								<?php
							}
						} 
					?>
			...
			<div class="row padding-20 flex-cols">
				<?php
					...
					foreach($locations as $location) {
						...
						$columns = ($count==5 or $count==6 or $count==9) ? "col-1of3" : "col-1of4";
						$columns = ($count==10) ? "col-1of2" : $columns;
