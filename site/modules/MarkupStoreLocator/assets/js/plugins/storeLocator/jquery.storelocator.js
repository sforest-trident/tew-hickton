...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		// Templates
		'infowindowTemplatePath'     : '/site/modules/MarkupStoreLocator/assets/js/plugins/storeLocator/templates/infowindow-description.html',
		'listTemplatePath'           : '/site/modules/MarkupStoreLocator/assets/js/plugins/storeLocator/templates/location-list-description.html',
		'KMLinfowindowTemplatePath'  : '/site/modules/MarkupStoreLocator/assets/js/plugins/storeLocator/templates/kml-infowindow-description.html',
		'KMLlistTemplatePath'        : '/site/modules/MarkupStoreLocator/assets/js/plugins/storeLocator/templates/kml-location-list-description.html',
		'listTemplateID'             : null,
